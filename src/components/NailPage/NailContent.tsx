    ...
    <div className="subServiceContent-container">
      <div className="subServicesMain-item">
        ...
        <p>
          ...
          Whether you want a subtle, elegant look or a bold, trendy design, our
          experts use premium products to ensure stunning results.
        </p>
        <p>
          ...
          promote strong, resilient nails.
        </p>
        <p>
          ...
          your skin tone and style, ensuring a flawless and lasting look.
        </p>
        <p>
        ...
        <p>
          ...
          sterilized tools to ensure the highest safety standards. Our team
          takes the time to understand your preferences and provide a
        ...
        <p>
          ...
          enjoy your nail care services at your convenience.
        </p>
        <p>
          ...
          receives luxury services without compromising on affordability.
        </p>
        <p>
